# Meridian TWIN Quick Start  
  
Meridian TWINの導入方法について, 下記のgithubのREADMEを転記します.  
ソースファイルは下記よりDLして進めてください.  <br>  

[https://github.com/Ninagawa123/Meridian_TWIN](https://github.com/Ninagawa123/Meridian_TWIN)  
<br>
